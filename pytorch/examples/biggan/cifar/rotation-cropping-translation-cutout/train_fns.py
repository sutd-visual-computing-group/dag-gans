    ...
    def train(x, y):
        ...
        for step_index in range(config['num_D_steps']):
            ...
            for accumulation_index in range(config['num_D_accumulations']):
                ...
                D_loss_real_rotate180, D_loss_fake_rotate180 = losses.discriminator_loss(D_fake_rotate180, D_real_rotate180)
                D_loss_real_rotate270, D_loss_fake_rotate270 = losses.discriminator_loss(D_fake_rotate270, D_real_rotate270)
                # croping
                ...
                D_loss_real_translation, D_loss_fake_translation = losses.discriminator_loss(D_fake_translation, D_real_translation)
                D_loss_real_cutout, D_loss_fake_cutout = losses.discriminator_loss(D_fake_cutout, D_real_cutout)
        ...
        if not config['fix_G']:
            ...
            for accumulation_index in range(config['num_G_accumulations']):
                ...
                G_loss_rotate180 = losses.generator_loss(D_fake_rotate180) / float(config['num_G_accumulations'])
                G_loss_rotate270 = losses.generator_loss(D_fake_rotate270) / float(config['num_G_accumulations'])
                # cropping
                ...
                # translation and cutout
                G_loss_translation  = losses.generator_loss(D_fake_translation)  / float(config['num_G_accumulations'])
                G_loss_cutout       = losses.generator_loss(D_fake_cutout)  / float(config['num_G_accumulations'])
